...
// Fetch user info untuk pre-fill form
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Breadcrumb */
        .breadcrumb-bar {
            padding: 1.2rem 4rem; border-bottom: 1px solid #f5f5f5; background: white;
        ...
        .form-label {
            font-size: 0.8rem; font-weight: 700; color: #7f8c8d;
        ...
        .form-control:focus {
            border-color: var(--accent); box-shadow: 0 0 0 4px rgba(255,142,83,0.1);
        ...
        /* Payment method */
        .payment-option {
            border: 2px solid #f0f0f0; border-radius: 16px; padding: 1.2rem 1.5rem;
            cursor: pointer; transition: 0.2s; display: flex; align-items: center; gap: 14px;
        ...
        .payment-radio {
            ...
            border: 2px solid #ddd; flex-shrink: 0; transition: 0.2s;
            display: flex; align-items: center; justify-content: center;
        }
            ...
            <div class="col-lg-7">
                ...
                <div class="form-card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12" id="addressField">
                            ...
                            <textarea id="shipping_address" class="form-control" rows="3"
                ...
                <div class="form-card">
                    ...
                    <div class="payment-option selected" onclick="selectDelivery('delivery', this)">
                        ...
                        <div class="payment-icon" style="background:#fff0e8;color:#FF8E53;">
                            <i class="bi bi-truck"></i>
                        </div>
                        <div>
                            <div class="payment-label">Home Delivery</div>
                            <div class="payment-desc">Delivered to your address · RM 3.50</div>
                        </div>
                    </div>
                    ...
                    <div class="payment-option" onclick="selectDelivery('pickup', this)">
                        ...
                        <div class="payment-radio"></div>
                        <div class="payment-icon" style="background:#e8fdf0;color:#00b894;">
                            <i class="bi bi-shop"></i>
                        </div>
                        <div>
                            <div class="payment-label">Self Pickup</div>
                            <div class="payment-desc">Pick up at our store · Free</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    ...
                    <div class="payment-option selected" onclick="selectPayment('online_banking', this)">
                        ...
                        <div class="payment-radio"></div>
                        <div class="payment-icon" style="background:#e8f4fd;color:#0984e3;">
                            <i class="bi bi-bank"></i>
                        </div>
                        <div>
                            <div class="payment-label">Online Banking</div>
                            <div class="payment-desc">FPX — Maybank, CIMB, RHB & more</div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5">
                <div class="summary-card">
                    ...
                    <div class="summary-row" id="deliveryRow">
                        <span>Delivery</span>
                        <span id="deliveryVal">RM 3.50</span>
                    </div>
                    ...
                    <div class="summary-row summary-total">
                        <span>Total</span>
                        <span id="totalVal">RM <?= number_format($total, 2) ?></span>
                    </div>
...
function selectPayment(method, el) {
    ...
    document.querySelectorAll('[name="payment"]').closest
        ? null : null;
    el.closest('.form-card').querySelectorAll('.payment-option')
