...
$recent      = $conn->query("SELECT o.*, u.username as customer_name FROM orders o JOIN users u ON o.user_id = u.user_id ORDER BY o.created_at DESC LIMIT 8");
...
<head>
    ...
    <title>Staff Dashboard – Foodify</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero-banner { background: linear-gradient(135deg, #1A1C1E 0%, #2D3436 100%); border-radius: 28px; padding: 2.2rem 2.5rem; margin-bottom: 2rem; color: white; position: relative; overflow: hidden; }
...
<div class="main-content">
    <div class="hero-banner">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="fw-bold mb-1" style="font-size:1.8rem;">Staff Dashboard</h1>
                <p class="opacity-75 mb-0">Welcome back, <?= htmlspecialchars($staff_username) ?></p>
            </div>
            <div class="text-end">
