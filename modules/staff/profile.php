    ...
    <ul class="sidebar-nav">
        ...
        <li>
            <a href="manage_items.php">
                <i class="bi bi-bag-heart-fill"></i> Manage Items
            </a>
        </li>
    ...
    <div class="sidebar-footer">
        <a href="profile.php" class="text-decoration-none d-block">
            <div class="user-card d-flex align-items-center gap-3 mb-3">
                ...
                <?php else: ?>
                    <div class="text-white rounded-3 p-2 d-flex justify-content-center align-items-center"
                         style="width:42px;height:42px;background:var(--primary-grad);">
                ...
                <div class="overflow-hidden">
                    ...
                    <div style="font-size:0.65rem;color:var(--accent);font-weight:600;text-transform:uppercase;">
                        <?= ucfirst($nav_role) ?>
                    </div>
                </div>
            </div>
        ...
        <a href="../auth/logout.php"
           class="btn btn-outline-danger w-100 rounded-3 py-2 border-opacity-25"
